...
public class fomulario extends javax.swing.JFrame {
    ...
    public fomulario() {
        initComponents();
		this.introducitLesiones();
    }
    
	private void introducitLesiones() {
    ...
    private void initComponents() {
        ...
        r_anareobica_sup = new javax.swing.JComboBox();
        jLabel15 = new javax.swing.JLabel();
        r_anareobica_inf = new javax.swing.JComboBox();
        ...
        r_anareobica_sup.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Muy mala", "Mala", "Regular", "Buena", "Muy Buena" }));
        r_anareobica_sup.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                r_anareobica_supActionPerformed(evt);
            }
        });

        jLabel15.setText("Resultado prueba anaeróbica inf.");

        r_anareobica_inf.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Muy mala", "Mala", "Regular", "Buena", "Muy Buena" }));
        r_anareobica_inf.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                r_anareobica_infActionPerformed(evt);
            }
        });
                ...
                .addGroup(jPanel1Layout.createParallelGroup( GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel1Layout.createParallelGroup( GroupLayout.Alignment.LEADING, false)
                        ...
                        .addGroup(jPanel1Layout.createSequentialGroup()
                            ...
                            .addGap(18, 18, 18)
                            .addGroup(jPanel1Layout.createParallelGroup( GroupLayout.Alignment.LEADING, false)
                                .addComponent(r_anareobica_inf,  GroupLayout.PREFERRED_SIZE, 92,  GroupLayout.PREFERRED_SIZE)
                                .addComponent(r_anareobica_sup,  GroupLayout.PREFERRED_SIZE, 92,  GroupLayout.PREFERRED_SIZE)))))
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup( GroupLayout.Alignment.LEADING, false)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup( GroupLayout.Alignment.BASELINE)
                            .addComponent(jLabel14)
                            .addComponent(r_anareobica_sup,  GroupLayout.PREFERRED_SIZE,  GroupLayout.DEFAULT_SIZE,  GroupLayout.PREFERRED_SIZE))
                        .addGap(18, 18, 18)
                        .addGroup(jPanel1Layout.createParallelGroup( GroupLayout.Alignment.BASELINE)
                            .addComponent(jLabel15)
                            .addComponent(r_anareobica_inf,  GroupLayout.PREFERRED_SIZE,  GroupLayout.DEFAULT_SIZE,  GroupLayout.PREFERRED_SIZE))
                        .addGap(18, 18, 18))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup( GroupLayout.Alignment.BASELINE)
    ...
    private void r_anareobica_infActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_r_anareobica_infActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_r_anareobica_infActionPerformed

    private void r_anareobica_supActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_r_anareobica_supActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_r_anareobica_supActionPerformed
    ...
    private void continuarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_continuarActionPerformed
		...
		if(this.camposCompletos()){
			...
			if(objetivo.getSelectedItem().equals("Hipertrofia")&& dias.getSelectedIndex()<3){
				JOptionPane.showMessageDialog(this,"No se pueden seleccionar menos de 3 días con el objetivo de Hipertrofia");
			}
    ...
    private javax.swing.JComboBox r_anareobica_inf;
    private javax.swing.JComboBox r_anareobica_sup;
