...
public class Formulario extends javax.swing.JFrame {
	...
	private void initComponents() {
        ...
        objetivo.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tonificaci贸n", "Hipertrofia", "Perdida de peso", "Mantenimiento" }));
        ...
        jLabel12.setText("D韆s de entrenamiento/semana");
        ...
        jLabel13.setText("Resultado prueba aer贸bica");
        ...
        jLabel14.setText("Resultado prueba anaer贸bica sup.");
        ...
        jLabel15.setText("Resultado prueba anaer贸bica inf.");
        ...
        jLabel16.setText("Resultado prueba anaer骲ica Ab.");
    ...
    private void continuarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_continuarActionPerformed
		...
		if(this.camposCompletos()){
			...
			if(objetivo.getSelectedItem().equals("Hipertrofia")&& dias.getSelectedIndex()+1<3){
				JOptionPane.showMessageDialog(this,"No se pueden seleccionar menos de 3 d韆s con el objetivo de Hipertrofia"+dias.getSelectedIndex());
			}
